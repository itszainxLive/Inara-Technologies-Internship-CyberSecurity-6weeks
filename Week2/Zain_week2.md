...
<img src="screenshots/image2.png" style="width:5.76736in;height:2.11528in" />
...
<img src="screenshots/image3.png" style="width:5.76667in;height:1.96667in" />

<img src="screenshots/image4.png" style="width:5.76111in;height:1.61458in" />

1.  **<u>DNS resolution flow; common record types; querying with dig and nslookup:-</u>**

    <img src="screenshots/image5.png" style="width:5.75764in;height:2.00347in" />
...
<img src="screenshots/image6.png" style="width:3.875in;height:1.94792in" />

finds the IP address of a website name.

2.  **<u>Static routes, gateways, and inspecting routes from the command line:-</u>**

    <img src="screenshots/image7.png" style="width:5.76319in;height:0.92153in" />
    ...
    <img src="screenshots/image8.png" style="width:5.76667in;height:0.68403in" />

    It s shows your default gateway

3.  **<u>HTTP request/response cycle and common status codes:-</u>**

    <img src="screenshots/image9.png" style="width:5.28472in;height:2.31389in" />

It sends a request to a website and shows you everything that happens step by step.

<img src="screenshots/image10.png" style="width:5.76111in;height:2.77431in" />

4.  **<u>TLS handshake; SSL certificate basics: chains, CAs, validity, and viewing a certificate:-</u>**

    <img src="screenshots/image11.png" style="width:5.76389in;height:3.89931in" />
...
<img src="screenshots/image12.png" style="width:5.76736in;height:3.94097in" />

<img src="screenshots/image13.png" style="width:5.76736in;height:0.69375in" />

It picks out just the important parts of the certificate who it belongs to, who gave it out, and how long it stays valid.

**Practical:-**

<img src="screenshots/image14.png" style="width:5.31042in;height:3.60625in" />

<img src="screenshots/image15.png" style="width:5.76597in;height:1.51319in" />
...
<img src="screenshots/image16.png" style="width:5.76111in;height:1.31458in" />

1.  **<u>VLANs: access vs trunk ports, 802.1Q tagging, native VLAN:-</u>**

    **VLAN — 802.1Q:**

    <img src="screenshots/image17.png" style="width:5.76111in;height:0.82639in" />

    It creates a VLAN interface with tag number 10 on top of your main network card .

    **Access vs Trunk Port :**

    <img src="screenshots/image18.png" style="width:5.7625in;height:2.28333in" />

    **Native VLAN :**

    <img src="screenshots/image19.png" style="width:3.69792in;height:1.25in" />

    It is used to delete that link.

2.  **<u>NAT concepts: source/destination NAT, port address translation:-</u>**

    <img src="screenshots/image20.png" style="width:5.76667in;height:1.43542in" />
    ...
    <img src="screenshots/image21.png" style="width:5.76736in;height:0.92708in" />
...
<img src="screenshots/image22.png" style="width:5.76181in;height:2.72778in" />
...
<img src="screenshots/image23.png" style="width:5.76597in;height:1.54236in" />
...
<img src="screenshots/image24.png" style="width:5.76458in;height:2.24653in" />

It helps you see where a connection might be slow or broken.

<img src="screenshots/image25.png" style="width:5.76111in;height:1.27639in" />
...
<img src="screenshots/image26.png" style="width:5.76181in;height:2.07431in" />

It shows open ports and active connections, and additionally tells you which program is using each one.

<img src="screenshots/image27.png" style="width:5.75833in;height:1.91944in" />

It shows NAT rules on system.

<img src="screenshots/image28.png" style="width:5.76597in;height:1.51111in" />

1.  **<u>iptables tables and chains; rule structure and targets:-</u>**

    <img src="screenshots/image29.png" style="width:5.52431in;height:2.13611in" />
...
<img src="screenshots/image30.png" style="width:5.7625in;height:0.98819in" />
...
2.  **<u>The filter table and the nat table in practice:-</u>**
    ...
    <img src="screenshots/image31.png" style="width:5.76389in;height:1.45139in" />

<img src="screenshots/image32.png" style="width:5.76319in;height:1.98819in" />

filter table controls "allow/block" decisions, while nat table controls "address translation" decisions.

<img src="screenshots/image33.png" style="width:5.76597in;height:1.09514in" />
...
<img src="screenshots/image34.png" style="width:5.76597in;height:1.1875in" />

It adds a final rule at the end of the INPUT chain that blocks (drops) everything else that wasn't already allowed.

<img src="screenshots/image35.png" style="width:5.75764in;height:1.35972in" />

3.  **<u>Simplified rules with ufw; zone-based control with firewalld:-</u>**

    <img src="screenshots/image36.png" style="width:2.94792in;height:0.84375in" />

    This is used to Allow port 443 through ufw command.

    <img src="screenshots/image37.png" style="width:5.11458in;height:2.44792in" />

    It block All incomming traffic and Allow all outgoing .

    UfW enable It is used to activate firewall .

    <img src="screenshots/image38.png" style="width:4.98403in;height:2.20486in" />

    **Firewalld :-**

    <img src="screenshots/image39.png" style="width:5.76597in;height:2.79167in" />
...
4.  **<u>Application confinement with AppArmor:-</u>**
    ...
    <img src="screenshots/image40.png" style="width:4.92708in;height:2.37361in" />
...
<img src="screenshots/image41.png" style="width:5.75833in;height:2.37639in" />

<img src="screenshots/image42.png" style="width:5.04722in;height:3.88889in" />
...
<img src="screenshots/image43.png" style="width:5.76667in;height:1.49375in" />

1.  **<u>Capturing traffic with Wireshark and tcpdump:-</u>**

    **<u>Wireshark :-</u>**

    <img src="screenshots/image44.png" style="width:5.76389in;height:2.52014in" />
...
<img src="screenshots/image45.png" style="width:5.75694in;height:2.16667in" />
...
<img src="screenshots/image46.png" style="width:5.76667in;height:1.07153in" />

<img src="screenshots/image47.png" style="width:5.76597in;height:0.92083in" />

<img src="screenshots/image48.png" style="width:5.76389in;height:0.93125in" />

It shows captured network traffic filtered by different protocols such as **TLS, DNS, and TCP.**

**TCP DUMP:-**

<img src="screenshots/image49.png" style="width:5.75972in;height:0.82014in" />

<img src="screenshots/image50.png" style="width:5.76181in;height:1.21944in" />
...
3.  **<u>Command-line capture workflows with tcpdump for remote/headless hosts:-</u>**
    ...
    <img src="screenshots/image51.png" style="width:5.50972in;height:1.76458in" />
...
<img src="screenshots/image52.png" style="width:5.76597in;height:1.06181in" />

<img src="screenshots/image53.png" style="width:5.76181in;height:0.74583in" />
